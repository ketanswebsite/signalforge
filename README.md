...
| Endpoint test harness (every route, every page contract) | 1.0 | 2026-09-24 · endpoint | ✅ Working: 206 specs (144 live routes, 4 unmounted Stripe routes, 58 removed routes), 846 cases; 833 pass and 13 known bugs fail as expected. Fresh scratch database and server per run, cron stubbed, no network. |
