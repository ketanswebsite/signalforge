...
| Endpoint test harness (every route, every page contract) | 1.0 | 2026-09-24 · endpoint | ✅ Working: 205 specs (143 live routes, 4 unmounted Stripe routes, 58 removed routes), 839 cases; 825 pass and 14 known bugs fail as expected. Fresh scratch database and server per run, cron stubbed, no network. |
