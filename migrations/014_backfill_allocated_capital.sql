-- ========================================
-- Migration: 014 - Backfill Allocated Capital for Existing Trades
-- Description: Calculate and allocate capital for trades that were created before capital allocation was implemented
-- Date: 2025-10-16
-- ========================================
...
BEGIN
    ...
    RAISE NOTICE '✅ Backfilled allocated capital:';
