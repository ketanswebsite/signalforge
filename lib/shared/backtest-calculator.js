...
const DTICalculator = require('./dti-calculator');
...
function runBacktest(stockData, params = {}) {
    ...
    const dti = DTICalculator.calculateDTI(stockData.high, stockData.low, r, s, u);
    const sevenDayDTIData = DTICalculator.calculate7DayDTI(
        stockData.dates, 
        stockData.high, 
        stockData.low, 
        r, s, u
