    ...
    function generateCSVContent(trades) {
        ...
        for (const trade of trades) {
            ...
            const row = [
                ...
                trade.holdingDays,
                trade.prevDTI !== undefined ? trade.prevDTI.toFixed(2) : 'N/A',
                trade.entryDTI !== undefined ? trade.entryDTI.toFixed(2) : 'N/A',
                trade.prev7DayDTI !== undefined ? trade.prev7DayDTI.toFixed(2) : 'N/A',
                trade.entry7DayDTI !== undefined ? trade.entry7DayDTI.toFixed(2) : 'N/A',
                trade.historicalSignalCount || 0,
