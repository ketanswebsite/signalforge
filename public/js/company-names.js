...
window.CompanyNames = (function() {
    ...
    const companyMappings = {
        ...
        'FOUR.L': '4Imprint Group Plc',        'ASL.L': 'Aberforth Smaller Companies Trust Plc',        'AAS.L': 'Abrdn Asia Focus Plc',
        'AAIF.L': 'Abrdn Asian Income Fund Limited',        'ADIG.L': 'Abrdn Diversified Income And Growth Plc',
        'AEI.L': 'Abrdn Equity Income Trust Plc',
        'ASLI.L': 'Abrdn European Logistics Income Plc',
        'ANII.L': 'Abrdn New India Investment Trust Plc',
        'ABDN.L': 'Abrdn Plc',        'API.L': 'Abrdn Property Income Trust Limited',        'ASCB.L': 'Abrdn Smaller Companies Income Trust Plc',        'AUSC.L': 'Abrdn Uk Smaller Companies Growth Trust Plc',
        'AC8.L': 'Acceler8 Ventures Plc',
        'ACG.L': 'Acg Acquisition Company Limited',        'ZAIM.L': 'Adalan Ventures Plc',        'ADM.L': 'Admiral Group Plc',        'ADVT.L': 'Advancedadvt Limited',
        '87FZ.L': 'Aeci Ld',
        ...
        'AJB.L': 'Aj Bell Plc',        'AAEV.L': 'Albion Enterprise Vct Plc',
        'AATG.L': 'Albion Technology & General Vct Plc',        'ALFA.L': 'Alfa Financial Software Holdings Plc',
        'ALNA.L': 'Alina Holdings Plc',
        'ALK.L': 'Alkemy Capital Investments Plc',        'ATT.L': 'Allianz Technology Trust Plc',        'AWE.L': 'Alphawave Ip Group Plc',        'AIRE.L': 'Alternative Income Reit Plc',
        'REE.L': 'Altona Rare Earths Plc',
        'ALTN.L': 'Altyngold Plc',
        'DISH.L': 'Amala Foods Plc',        'AMIF.L': 'Amicorp Fs (Uk) Plc',
        ...
        'ANTO.L': 'Antofagasta Plc',        'APTD.L': 'Aptitude Software Group Plc',
        'AEEE.L': 'Aquila Energy Efficiency Trust Plc',
        'AEET.L': 'Aquila Energy Efficiency Trust Plc',
        'AERI.L': 'Aquila European Renewables Plc',
        'AERS.L': 'Aquila European Renewables Plc',        'ARB.L': 'Argo Blockchain Plc',        'ASAI.L': 'Asa International Group Plc',        'ASPL.L': 'Aseana Properties Limited',
        ...
        'AHT.L': 'Ashtead Group Plc',        'ASIA.L': 'Asia Strategic Holdings Limited',
        'AEIP.L': 'Asian Energy Impact Trust Plc',        'ASC.L': 'Asos Plc',
        ...
        'ATN.L': 'Aterian Plc',
        'ATY.L': 'Athelney Trust Plc',        'ATG.L': 'Auction Technology Group Plc',
        ...
        'AVAP.L': 'Avation Plc',        'AGT.L': 'Avi Global Trust Plc',
        'AJOT.L': 'Avi Japan Opportunity Trust Plc',        'AV.A.L': 'Aviva Plc',        'AVON.L': 'Avon Protection Plc',
        'BME.L': 'B&M European Value Retail S.A.',
        'BAB.L': 'Babcock International Group Plc',        'BGCG.L': 'Baillie Gifford China Growth Trust Plc',
        ...
        'BAKK.L': 'Bakkavor Group Plc',        'BBY.L': 'Balfour Beatty Plc',
        'BCG.L': 'Baltic Classifieds Group Plc',
        'BVA.L': 'Banco Bilbao Vizcaya Argentaria S.A.',
        'BNC.L': 'Banco Santander S.A.',        'BGEO.L': 'Bank Of Georgia Group Plc',
        'BKIC.L': 'Bank Of Ireland (Governor & Company Of The)',        'BIRG.L': 'Bank Of Ireland Group Plc',
        ...
        'BAG.L': 'Barr (A.G.) Plc',        'BVC.L': 'Batm Advanced Communications Ld',
        'BAY.L': 'Bay Capital Plc',        'BRS.L': 'Beacon Rise Holdings Plc',
        'BEZ.L': 'Beazley Plc',
        ...
        'BRSC.L': 'Blackrock Smaller Co Trust Plc',        'THRG.L': 'Blackrock Throgmorton Trust Plc',
        'BRWM.L': 'Blackrock World Mining Trust Plc',
        'BGLF.L': 'Blackstone Loan Financing Limited',        'BRES.L': 'Blencowe Resources Plc',
        ...
        'BIH.L': 'Boston International Holdings Plc',        'BP..L': 'Bp Plc',        'BMS.L': 'Braemar Plc',
        'BREE.L': 'Breedon Group Plc',
        'BPT.L': 'Bridgepoint Group Plc',        'BWRA.L': 'Bristol Water Plc',
        ...
        'BSC.L': 'British Smaller Companies Vct2 Plc',        'BASC.L': 'Brown Advisory Us Smaller Companies Plc',        'BUT.L': 'Brunner Investment Trust Plc',
        'BSFA.L': 'Bsf Enterprise Plc',        'BNZL.L': 'Bunzl Plc',
        ...
        'CPI.L': 'Capita Plc',        'CGT.L': 'Capital Gearing Trust Plc',
        ...
        'CCL.L': 'Carnival Plc',
        'CARR.L': 'Carr\'S Group Plc',        'CGS.L': 'Castings Plc',
        'CCJI.L': 'Cc Japan Income & Growth Trust Plc',        'CAU.L': 'Centaur Media Plc',
        'CNA.L': 'Centrica Plc',
        ...
        'CHRY.L': 'Chrysalis Investments Limited',        'CLIG.L': 'City Of London Investment Group Plc',
        ...
        'CCH.L': 'Coca-Cola Hbc Ag',        'COD.L': 'Compagnie De Saint-Gobain',
        ...
        'CRST.L': 'Crest Nicholson Holdings Plc',        'CRH.L': 'Crh Plc',
        ...
        'CURY.L': 'Currys Plc',        'CREI.L': 'Custodian Property Income Reit Plc',
        'CVCE.L': 'Cvc Income & Growth Limited',
        'CVCG.L': 'Cvc Income & Growth Limited',
        'DAL.L': 'Dalata Hotel Group Plc',
        'DAR.L': 'Dar Global Plc',        'DAT.L': 'Datang International Power Generation Company Ld',
        'DVT.L': 'Davictus Plc',
        'DCC.L': 'Dcc Plc',
        'DLAR.L': 'De La Rue Plc',        'ROO.L': 'Deliveroo Plc',
        'DLN.L': 'Derwent London Plc',
        'DVNO.L': 'Develop North Plc',        'DFIB.L': 'Dfi Retail Group Holdings Limited',
        'DFIJ.L': 'Dfi Retail Group Holdings Limited',
        'DFS.L': 'Dfs Furniture Plc',        'DGE.L': 'Diageo Plc',        'DIA.L': 'Dialight Plc',
        'DGI9.L': 'Digital 9 Infrastructure Plc',
        'DPLM.L': 'Diploma Plc',        'DSCV.L': 'Discoverie Group Plc',        'DIVI.L': 'Diverse Income Trust (The) Plc',
        ...
        'DSM.L': 'Downing Strategic Micro-Cap Investment Trust Plc',        'DOCS.L': 'Dr. Martens Plc',
        'DRX.L': 'Drax Group Plc',        'DIG.L': 'Dunedin Income Growth Investment Trust Plc',
        'DNLM.L': 'Dunelm Group Plc',        'EST.L': 'East Star Resources Plc',
        'EZJ.L': 'Easyjet Plc',
        ...
        'EWI.L': 'Edinburgh Worldwide Investment Trust Plc',        'ELEG.L': 'Electric Guitar Plc',
        'ELM.L': 'Elementis Plc',
        ...
        'ENQ.L': 'Enquest Plc',
        'ENT.L': 'Entain Plc',
        'ESOZ.L': 'Epe Special Opportunities Limited',        'ESNT.L': 'Essentra Plc',
        'ECEL.L': 'Eurocell Plc',
        ...
        'FHP.L': 'Fandango Holdings Plc',        'FDM.L': 'Fdm Group (Holdings) Plc',
        'FERG.L': 'Ferguson Plc',
        'FXPO.L': 'Ferrexpo Plc',
        ...
        'FSV.L': 'Fidelity Special Values Plc',        'FGT.L': 'Finsbury Growth & Income Trust Plc',        'FCM.L': 'First Class Metals Plc',
        '1SN.L': 'First Tin Plc',
        ...
        'FSFL.L': 'Foresight Solar Fund Limited',        'FWT.L': 'Foresight Technology Vct Plc',
        ...
        'FUTR.L': 'Future Plc',        'GFRD.L': 'Galliford Try Holdings Plc',
        ...
        'GENL.L': 'Genel Energy Plc',        'GACB.L': 'General Accident Plc',        'GENF.L': 'Genflow Biosciences Plc',
        ...
        'GOT.L': 'Global Opportunities Trust Plc',        'GCG.L': 'Golden Rock Global Plc',
        'GDWN.L': 'Goodwin Plc',
        'GSF.L': 'Gore Street Energy Storage Fund Plc',        'GRI.L': 'Grainger Plc',
        'GTE.L': 'Gran Tierra Energy Inc.',        'GVMH.L': 'Grand Vision Media Holdings Plc',
        ...
        'GRG.L': 'Greggs Plc',        'GV1O.L': 'Gresham House Renewable Energy Vct 1 Plc',        'GV2O.L': 'Gresham House Renewable Energy Vct 2 Plc',        'GRIT.L': 'Grit Investment Trust Plc',
        'GR1T.L': 'Grit Real Estate Income Group Limited',
        'GSC.L': 'Gs Chain Plc',
        'GSK.L': 'Gsk Plc',
        'GST.L': 'Gstechnologies Ltd',        'GVCT.L': 'Guinness Vct Plc',
        ...
        'HHV.L': 'Hargreave Hale Aim Vct Plc',        'HWG.L': 'Harworth Group Plc',        'HAS.L': 'Hays Plc',
        'HEAD.L': 'Headlam Group Plc',        'HLCL.L': 'Helical Plc',
        'HTWS.L': 'Helios Towers Plc',
        'HELD.L': 'Hellenic Dynamics Plc',
        'HEMO.L': 'Hemogenyx Pharmaceuticals Plc',
        'HDIV.L': 'Henderson Diversified Income Trust Plc',        'HFEL.L': 'Henderson Far East Income Limited',
        'HHI.L': 'Henderson High Income Trust Plc',
        'HINT.L': 'Henderson International Income Trust Plc',        'HSL.L': 'Henderson Smaller Companies Investment Trust Plc',
        'HRI.L': 'Herald Investment Trust Plc',
        'HGT.L': 'Hg Capital Trust Plc',
        'HICL.L': 'Hicl Infrastructure Plc',
        'HID.L': 'Hidong Estate Plc',        'HWC.L': 'Highway Capital Plc',
        'HIK.L': 'Hikma Pharmaceuticals Plc',
        'HILS.L': 'Hill & Smith Plc',
        'HFG.L': 'Hilton Food Group Plc',        'SONG.L': 'Hipgnosis Songs Fund Limited',        'HSX.L': 'Hiscox Ltd',
        ...
        'HKLJ.L': 'Hong Kong Land Holdings Ld',        'HSW.L': 'Hostelworld Group Plc',        'HWDN.L': 'Howden Joinery Group Plc',
        'HSBA.L': 'Hsbc Holdings Plc',
        'HTG.L': 'Hunting Plc',        'HUI.L': 'Hydrogen Utopia International Plc',
        ...
        'IMI.L': 'Imi Plc',        'IEM.L': 'Impax Environmental Markets Plc',
        'IMB.L': 'Imperial Brands Plc',
        'INCH.L': 'Inchcape Plc',
        'IGV.L': 'Income & Growth Vct (The) Plc',
        'IGC.L': 'India Capital Growth Fund Limited',        'INF.L': 'Informa Plc',
        'INLZ.L': 'Inland Zdp Plc',
        'IHP.L': 'Integrafin Holdings Plc',
        'IDHC.L': 'Integrated Diagnostics Holdings Plc',
        'IHG.L': 'Intercontinental Hotels Group Plc',        'IBT.L': 'International Biotechnology Trust Plc',        'IAG.L': 'International Consolidated Airlines Group S.A.',        'IPF.L': 'International Personal Finance Plc',
        'INPP.L': 'International Public Partnerships Ld',
        'ITRK.L': 'Intertek Group Plc',        'BIPS.L': 'Invesco Bond Income Plus Limited',        'IVPB.L': 'Invesco Select Trust Plc',        'IVPM.L': 'Invesco Select Trust Plc',        '46HA.L': 'Investec Investment Trust Plc',
        '47HA.L': 'Investec Investment Trust Plc',
        'INVP.L': 'Investec Plc',
        'INV.L': 'Investment Company Plc',
        'IPO.L': 'Ip Group Plc',        'ICGC.L': 'Irish Continental Group Plc',
        'ITH.L': 'Ithaca Energy Plc',
        'ITV.L': 'Itv Plc',
        'IWG.L': 'Iwg Plc',
        'JAR.L': 'Jardine Matheson Holdings Ld',        'JARJ.L': 'Jardine Matheson Holdings Ld',        'JEL.L': 'Jersey Electricity Plc',
        ...
        'JII.L': 'Jpmorgan Indian Investment Trust Plc',        'JFJ.L': 'Jpmorgan Japanese Investment Trust Plc',
        'JMF.L': 'Jpmorgan Mid Capital Investment Trust Plc',        'JUSC.L': 'Jpmorgan Us Smaller Co. Inv Tst Plc',
        'JTC.L': 'Jtc Plc',
        'JUP.L': 'Jupiter Fund Management Plc',
        'JGC.L': 'Jupiter Green Investment Trust Plc',        'JUST.L': 'Just Group Plc',
        ...
        '70HF.L': 'Keystone Positive Change Investment Trust Plc',        'KIE.L': 'Kier Group Plc',        'KGF.L': 'Kingfisher Plc',        'KNM.L': 'Konami Group Corporation',
        'KOS.L': 'Kosmos Energy Ltd',        'LRE.L': 'Lancashire Holdings Limited',
        ...
        'LAS.L': 'London & Associated Properties Plc',        'LSEG.L': 'London Stock Exchange Group Plc',
        'LMP.L': 'Londonmetric Property Plc',
        'LWI.L': 'Lowland Investment Company Plc',
        'LSL.L': 'Lsl Property Services Plc',
        'LUCE.L': 'Luceco Plc',        'MGCI.L': 'M&G Credit Income Investment Trust Plc',
        'MNG.L': 'M&G Plc',        'MPO.L': 'Macau Property Opportunities Fund Limited',
        'MACF.L': 'Macfarlane Group Plc',
        'MAJE.L': 'Majedie Investments Plc',
        'EMG.L': 'Man Group Plc',
        'MNL.L': 'Manchester & London Investment Trust Plc',
        'MDO.L': 'Mandarin Oriental International Ld',        'MDOJ.L': 'Mandarin Oriental International Ld',
        'MKS.L': 'Marks And Spencer Group Plc',
        'MSLH.L': 'Marshalls Plc',
        '92IP.L': 'Marston\'S Plc',
        'MARS.L': 'Marston\'S Plc',        'MAW.L': 'Maruwa Co. Ltd',        'MAST.L': 'Mast Energy Developments Plc',
        ...
        'MRO.L': 'Melrose Industries Plc',        'MRC.L': 'Mercantile Investment Trust (The) Plc',
        '72HN.L': 'Merchants Trust Plc',
        'MRCH.L': 'Merchants Trust Plc',        'MTRO.L': 'Metro Bank Holdings Plc',        'MCT.L': 'Middlefield Canadian Income Pcc',
        'MWY.L': 'Mid-Wynd International Investment Trust Plc',
        'MIGO.L': 'Migo Opportunities Trust Plc',
        'MILA.L': 'Mila Resources Plc',
        'MII.L': 'Milton Capital Plc',        'MAB.L': 'Mitchells & Butlers Plc',
        'MTO.L': 'Mitie Group Plc',        'GLE.L': 'Mj Gleeson Plc',
        'MIG.L': 'Mobeus Income & Growth 2 Vct Plc',        'MIX.L': 'Mobeus Income & Growth Vct Plc',
        ...
        'MOON.L': 'Moonpig Group Plc',        'BA05.L': 'Morgan Advanced Materials Plc',
        ...
        'MYI.L': 'Murray International Trust Plc',        'NANO.L': 'Nanoco Group Plc',
        'NARF.L': 'Narf Industries Plc',
        'NG..L': 'National Grid Plc',        'NBS.L': 'Nationwide Building Society',
        'NWG.L': 'Natwest Group Plc',        'NBPE.L': 'Nb Private Equity Partners Limited',
        'NBPU.L': 'Nb Private Equity Partners Limited',
        'NCC.L': 'Ncc Group Plc',
        'NEO.L': 'Neo Energy Metals Plc',
        'NZI.L': 'Net Zero Infrastructure Plc',        'NCA2.L': 'New Century Aim Vct 2 Plc',        'NSI.L': 'New Star Investment Trust Plc',
        ...
        'ONDO.L': 'Ondo Insurtech Plc',        'ORNT.L': 'Orient Telecoms Plc',
        'OIG.L': 'Oryx International Growth Fund Ltd',
        'OSB.L': 'Osb Group Plc',
        'OXB.L': 'Oxford Biomedica Plc',        'OXIG.L': 'Oxford Instruments Plc',
        ...
        'PAY.L': 'Paypoint Plc',        'PSON.L': 'Pearson Plc',
        'PEMB.L': 'Pembroke Vct Plc',        'PNN.L': 'Pennon Group Plc',
        ...
        'PLUS.L': 'Plus500 Ltd',
        'PMGZ.L': 'Pmgr Securities 2025 Plc',        'PCFT.L': 'Polar Capital Global Financials Trust Plc',
        ...
        'PZC.L': 'Pz Cussons Plc',        'QLT.L': 'Quilter Plc',        'MODE.L': 'R8 Capital Investments Plc',
        ...
        '67GX.L': 'Redde Northgate Plc',        'RGL.L': 'Regional Reit Limited',        'REL.L': 'Relx Plc',        'RSW.L': 'Renishaw Plc',
        'RTO.L': 'Rentokil Initial Plc',
        'RESI.L': 'Residential Secure Income Plc',
        'RSG.L': 'Resolute Mining Limited',        'RHIM.L': 'Rhi Magnesita N.V.',
        'RCDO.L': 'Ricardo Plc',
        'RMV.L': 'Rightmove Plc',
        ...
        'RMII.L': 'Rm Infrastructure Income Plc',        'RWA.L': 'Robert Walters Plc',
        'ROC.L': 'Rockpool Acquisitions Plc',
        'RKW.L': 'Rockwood Strategic Plc',        'ROQ.L': 'Roquefort Therapeutics Plc',        '76ID.L': 'Rotork Plc',
        'ROR.L': 'Rotork Plc',
        'RS1.L': 'Rs Group Plc',        'RTW.L': 'Rtw Biotech Opportunities Ltd',        'RICA.L': 'Ruffer Investment Company Ltd',
        '46IE.L': 'S & U Plc',
        '47IE.L': 'S & U Plc',
        'SUS.L': 'S & U Plc',
        ...
        'SBRY.L': 'Sainsbury (J) Plc',        'SANB.L': 'Santander Uk Plc',
        'SVS.L': 'Savills Plc',
        ...
        'SST.L': 'Scottish Oriental Smaller Companies Trust Plc',        'SEIT.L': 'Sdcl Energy Efficiency Income Trust Plc',        'SCGL.L': 'Sealand Capital Galaxy Limited',
        ...
        'SIV.L': 'Sivota Plc',        'SMJ.L': 'Smart (J.) & Co. (Contractors) Plc',
        'SN..L': 'Smith & Nephew Plc',        'SMIN.L': 'Smiths Group Plc',
        ...
        'STAN.L': 'Standard Chartered Plc',        'SWEF.L': 'Starwood European Real Estate Finance Limited',
        'SRAD.L': 'Stelrad Group Plc',
        'STEM.L': 'Sthree Plc',
        'SEC.L': 'Strategic Equity Capital Plc',        'STS.L': 'Sts Global Income & Growth Trust Plc',
        'STVG.L': 'Stv Group Plc',        'SUPR.L': 'Supermarket Income Reit Plc',
        'SYME.L': 'Supply@Me Capital Plc',        'SIHL.L': 'Symphony International Holdings Ld',
        ...
        'TMIP.L': 'Taylor Maritime Investments Limited',        'TBCG.L': 'Tbc Bank Group Plc',        'TM1.L': 'Technology Minerals Plc',
        'TEP.L': 'Telecom Plus Plc',
        'TMPL.L': 'Temple Bar Investment Trust Plc',
        'TEM.L': 'Templeton Emerging Markets Investment Trust Plc',        'TSCO.L': 'Tesco Plc',
        'THAL.L': 'Thalassa Holdings Limited',
        'TV1.L': 'Thames Ventures Vct 1 Plc',
        'D467.L': 'Thames Ventures Vct 2 Plc',        'THS.L': 'Tharisa Plc',
        ...
        'THG.L': 'Thg Plc',        'TPOU.L': 'Third Point Investors Limited',
        'TGA.L': 'Thungela Resources Limited',        'TGR.L': 'Tirupati Graphite Plc',        'TPT.L': 'Topps Tiles Plc',
        ...
        'TRI.L': 'Trifast Plc',        'SOHO.L': 'Triple Point Social Housing Reit Plc',
        'TPV.L': 'Triple Point Venture Vct Plc',
        'BBOX.L': 'Tritax Big Box Reit Plc',
        'BOXE.L': 'Tritax Eurobox Plc',        'TRST.L': 'Trustpilot Group Plc',
        'TTG.L': 'Tt Electronics Plc',        'TLW.L': 'Tullow Oil Plc',
        'TFIF.L': 'Twentyfour Income Fund Limited',
        'SMIF.L': 'Twentyfour Select Monthly Income Fund Limited',        'UTLH.L': 'Uil Finance Limited',
        'UTLI.L': 'Uil Finance Limited',        'ULTP.L': 'Ultimate Products Plc',
        'UAV.L': 'Unicorn Aim Vct Plc',
        'UMR.L': 'Unicorn Mineral Resources Plc',
        'ULVR.L': 'Unilever Plc',        'UTG.L': 'Unite Group Plc',        'UPL.L': 'Upland Resources Limited',        'USF.L': 'Us Solar Fund Plc',
        ...
        'VOF.L': 'Vinacapital Vietnam Opportunity Fund Ld',        'VTY.L': 'Vistry Group Plc',
        'VOD.L': 'Vodafone Group Plc',
        'VTA.L': 'Volta Finance Limited',
        'VTAS.L': 'Volta Finance Limited',
        'FAN.L': 'Volution Group Plc',
        'VOX.L': 'Vox Valor Capital Limited',        'VSL.L': 'Vpc Specialty Lending Investments Plc',
        ...
        'WIL.L': 'Wilmington Plc',        'WISE.L': 'Wise Plc',
        '86IP.L': 'Witan Investment Trust Plc',        'WIZZ.L': 'Wizz Air Holdings Plc',        'WKP.L': 'Workspace Group Plc',
